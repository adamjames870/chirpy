...
func (q *Queries) UpdateUserNameAndEmail(ctx context.Context, arg UpdateUserNameAndEmailParams) (User, error) {
	row := q.db.QueryRowContext(ctx, updateUserNameAndEmail,
		arg.ID,
		arg.Email,
		arg.HashedPassword,
		arg.UpdatedAt,
